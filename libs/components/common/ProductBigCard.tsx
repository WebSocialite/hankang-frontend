				...
				<Box component={'div'} className={'info'}>
					...
					<div className={'options'}>
						{/* <div>
							...
							<span>{product?.propertyBeds} bed</span>
						</div>
						<div>
							<img src="/img/icons/room.svg" alt="" />
							<span>{product?.propertyRooms} rooms</span>
						</div>
						<div>
							<img src="/img/icons/expand.svg" alt="" />
							<span>{product?.propertySquare} m2</span>
						</div> */}
					</div>
					<Divider sx={{ mt: '15px', mb: '17px' }} />
					<div className={'bott'}>
						{/* <div>
							{product?.propertyRent ? <p>Rent</p> : <span>Rent</span>}
							{product?.propertyBarter ? <p>Barter</p> : <span>Barter</span>}
						</div> */}

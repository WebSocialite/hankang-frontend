...
const AddProduct = ({ initialValues, ...props }: any) => {
	...
	useEffect(() => {
		setInsertProductData({
			...
			// productRent: getproductData?.getproduct ? getproductData?.getProperty?.propertyRent : false,
						...
						<Stack className="description-box">
							...
							{/* <Stack className="config-row">
								...
								<Stack className="price-year-after-price">
									...
									<select
										className={'select-description'}
										value={insertProductData.propertySquare || 'select'}
										defaultValue={insertProductData.propertySquare || 'select'}
										onChange={({ target: { value } }) =>
											setInsertPropertyData({ ...insertProductData, propertySquare: parseInt(value) })
										}
									>
										<option disabled={true} selected={true} value={'select'}>
											Select
